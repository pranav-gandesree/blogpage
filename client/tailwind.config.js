  ...
  theme: {
	extend: {
		...
		backgroundImage: {
			...
			'card1lg': "url('../src/assets/Background/card1.webp')",
			'card1bg': "url('../src/assets/Background/Card 1 Mobile.webp')",
			'card2lgbg': "url('../src/assets/Background/Storage BG.webp')",
			'card2bg': "url('../src/assets/Background/storage ROM - mobile.webp')",
			'card3lgbg': "url('../src/assets/Background/Card 3.webp')",
			'card3bg': "url('../src/assets/Background/Card 3 Mobile.webp')",
			'card4lgbg': "url('../src/assets/Background/whatsapp section.webp')",
		...
		screens: {
			mobile: '320px', // Or your desired mobile width
		  },
